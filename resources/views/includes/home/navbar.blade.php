    ...
    <a href="{{ url('/') }}" class="navbar-brand">
        ...
        <div class="collapse navbar-collapse" id="navb">
            <ul class="navbar-nav ml-auto mr-3">
                ...
                <li class="nav-item mx-md-2"><a href="#travelcontent" class="nav-link page-scroll">Paket Travel</a></li>
                @guest
                    <li class="nav-item dropdown">
                        <a href="#" class="nav-link dropdown-toggle" id="navbardrop"
                            data-toggle="dropdown">Service</a>
                        <div class="dropdown-menu">
                            <a href="#footer" class="btn btn-sm-success dropdown-item page-scroll">KONTAK</a>
                          
                        </div>
                    </li>
                <li class="nav-item mx-md-2"><a href="#testimonialcontent" class="nav-link page-scroll">Testimonial</a></li>
                @endguest
                @auth
